...
namespace MOVIEEQUIZZZ
{
    public partial class Japanese : Form
    {
        ...
        public Japanese()
        {
            ...
            string path = Path.Combine(@"C:\Users\Nomio\OneDrive\Ажлын тавцан\Japanese.txt");
            if (File.Exists(path))
            {
        ...
        private void Japanese_Load(object sender, EventArgs e)
        {
        ...
        private void lbxhariultuud_MouseDown(object sender, EventArgs e)
        {
        ...
        private void btnDuusgah_Click(object sender, EventArgs e)
        {
            ...
            // Save score to JSON
            UserManager.SaveScore(UserManager.CurrentUser, "Japanese", score);
        ...
        private void lbxhariultuud_SelectedIndexChanged(object sender, EventArgs e)
        {
